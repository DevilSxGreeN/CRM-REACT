...
export function ActualizarTipoGestion() {
    ...
    const cargarDatosTipoGestion = async () => {
        try {
            const response = await axios.get(`http://144.126.136.43/api/tipo_gestion/${id_tipo_gestion}`);
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            await axios.patch(`http://144.126.136.43/api/tipo_gestion/${id_tipo_gestion}`, tipogestion);
