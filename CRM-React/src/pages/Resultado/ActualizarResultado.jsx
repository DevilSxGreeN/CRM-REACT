...
export function ActualizarResultado() {
    ...
    const cargarDatosResultado = async () => {
        try {
            const response = await axios.get(`http://144.126.136.43/api/resultado/${id_resultado}`);
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            await axios.patch(`http://144.126.136.43/api/resultado/${id_resultado}`, resultado);
