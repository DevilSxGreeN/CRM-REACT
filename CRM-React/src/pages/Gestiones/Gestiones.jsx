...
export function Gestiones() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const gestionResponse = await axios.get('http://144.126.136.43/api/gestion?_size=500');
                const usuarioResponse = await axios.get('http://144.126.136.43/api/usuario?_size=500');
                const clienteResponse = await axios.get('http://144.126.136.43/api/cliente?_size=500');
                const tipoGestionResponse = await axios.get('http://144.126.136.43/api/tipo_gestion?_size=500');
                const resultadoResponse = await axios.get('http://144.126.136.43/api/resultado?_size=500');
