...
export function CrearGestion() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const usuarioResponse = await axios.get('http://144.126.136.43/api/usuario');
                const clienteResponse = await axios.get('http://144.126.136.43/api/cliente');
                const tipoGestionResponse = await axios.get('http://144.126.136.43/api/tipo_gestion');
                const resultadoResponse = await axios.get('http://144.126.136.43/api/resultado');
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post('http://144.126.136.43/api/gestion', {
                id_usuario,
                id_cliente,
                id_tipo_gestion,
                id_resultado,
